...
def get_all_students():
    ...
    return jsonify({
        "students": [StudentReadModel.model_validate(s).model_dump(mode="json") for s in students]
    })
...
def create_student_by_id():
    ...
    student_data = StudentReadModel.model_validate(new_student).model_dump(mode="json")
    student_data["age"] = StudentReadModel.model_validate(new_student).age
